...
<div class="col-5">
  <div class="photo">
    <button type="button" class="btn btn-secondary" data-media-field="photo_id" data-media-value="{{old('photo_id') ?? $photo->formatted_photo ?? null}}">{{__('Add a photo')}}</button>
  </div>
</div>
...
<div class="col-7">
    ...
    <div class="form-group">
      ...
      <input type="text" id="tags" class="form-control" name="tags" data-pillfield="{{old('tags') ?? $photo->formatted_tags ?? null}}" value="" />
    </div>
